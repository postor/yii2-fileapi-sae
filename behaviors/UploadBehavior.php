...
namespace postor\fileapi\behaviors;
 ...
 * @package postor\fileapi\behaviors
...
class UploadBehavior extends Behavior
{
    ...
    public function attach($owner)
    {
        ...
        if (!is_array($this->attributes) || empty($this->attributes)) {
            ...
            foreach ($this->attributes as $attribute => $config) {
                ...
                $this->attributes[$attribute]['path'] = $this->attributes[$attribute]['path'] . DIRECTORY_SEPARATOR;
                $this->attributes[$attribute]['tempPath'] = $this->attributes[$attribute]['tempPath'] . DIRECTORY_SEPARATOR;
    ...
    protected function saveFile($attribute, $insert = true)
    {
        if (empty($this->owner->$attribute)) {
            ...
            if ($tempFile) {
                //var_dump($tempFile);
                if ($this->saeRename($tempFile, $file)) {
    ...
    public function saeRename($from,$to){

 ...
 * ```
 * ...
 * echo \postor\fileapi\Widget::widget([
 *     'name' => 'fileapi',
 *     'settings' => [
 *         'autoUpload' => true
 *     ]
 ...
 * ```
 * ...
 * echo $form->field($model, 'file')->widget('postor\fileapi\Widget', [
 *     'settings' => [
 *         'autoUpload' => true
 *     ]
 * ]);
...
class Widget extends InputWidget
{
    ...
    {
        return Yii::t('postor/' . $category, $message, $params, $language);
    }
    ...
    {
        if (!isset(Yii::$app->i18n->translations['postor/fileapi']) && !isset(Yii::$app->i18n->translations['postor/*'])) {
            Yii::$app->i18n->translations['postor/fileapi'] = [
                'class' => 'yii\i18n\PhpMessageSource',
                'basePath' => '@postor/fileapi/messages',
                'fileMap' => [
                    'postor/fileapi' => 'fileapi.php'
                ],
